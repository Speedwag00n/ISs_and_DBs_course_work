DROP FUNCTION GET_USER_OBJECTS;
...
DROP FUNCTION INSERT_OBJECT_SUGGESTION;
...
DROP FUNCTION INSERT_SERVICE_SUGGESTION;
...
DROP FUNCTION INSERT_SUGGESTION_REQUEST;
...
BEGIN
    ...
    INSERT INTO SUGGESTION_REQUEST (ID, SUGGESTION)
    VALUES (REQUEST_ID, SUGGESTION);
    RETURN 1;
END;
$$ LANGUAGE PLPGSQL;

DROP FUNCTION INSERT_OBJECT_OFFER_REQUEST;
...
BEGIN
    ...
    VALUES (NAME, CONTENT, AUTHOR)
    RETURNING id INTO REQUEST_ID;
    INSERT INTO OBJECT_OFFER_REQUEST (ID, OFFER, OBJECT)
    VALUES (REQUEST_ID, OFFER, OBJECT_ID);
    UPDATE OBJECT obj SET OBJECT_STATE='SHARED' WHERE obj.ID=OBJECT_ID;
    RETURN 1;
END;
$$ LANGUAGE PLPGSQL;

DROP FUNCTION INSERT_SERVICE_OFFER_REQUEST;
...
BEGIN
    ...
    VALUES (NAME, CONTENT, AUTHOR)
    RETURNING id INTO REQUEST_ID;
    INSERT INTO SERVICE_OFFER_REQUEST (ID, OFFER, SERVICE)
    VALUES (REQUEST_ID, OFFER, SERVICE);
    RETURN 1;
END;
$$ LANGUAGE PLPGSQL;

DROP FUNCTION INSERT_OFFER_COMMENT;
...
DROP FUNCTION INSERT_SUGGESTION_COMMENT;
...
DROP FUNCTION GET_OFFERS_IN_DORMITORY;
...
DROP FUNCTION GET_SERVICE_SUGGESTIONS_IN_DORMITORY;
...
DROP FUNCTION GET_OBJECT_SUGGESTIONS_IN_DORMITORY;
