...
(
    ID         INTEGER REFERENCES SUGGESTION ON UPDATE CASCADE ON DELETE CASCADE PRIMARY KEY,
    OBJECT     INTEGER REFERENCES OBJECT ON UPDATE CASCADE ON DELETE CASCADE     NOT NULL
);

CREATE TABLE OBJECT_OFFER_REQUEST
(
    ID INTEGER REFERENCES REQUEST (ID) ON UPDATE CASCADE ON DELETE CASCADE      PRIMARY KEY,
...
(
    ID         INTEGER REFERENCES SUGGESTION (ID) ON UPDATE CASCADE ON DELETE CASCADE PRIMARY KEY,
    SERVICE    INTEGER REFERENCES SERVICE (ID) ON UPDATE CASCADE ON DELETE CASCADE    NOT NULL
);
...
(
    ID         INTEGER REFERENCES REQUEST (ID) ON UPDATE CASCADE ON DELETE CASCADE    PRIMARY KEY NOT NULL,
    SUGGESTION INTEGER REFERENCES SUGGESTION (ID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL
);
...
(
    ...
    FOREIGN KEY (SUGGESTION) REFERENCES SERVICE_SUGGESTION (ID) ON UPDATE CASCADE ON DELETE CASCADE
);